...
def main():
    ...
    parser.add_argument('--captcha-api-key', type=str, default=None, help='2Captcha API key')
    parser.add_argument('--no-manual-captcha', action='store_true', help='Disable manual CAPTCHA')
